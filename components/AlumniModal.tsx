		...
		<>
			...
			<div
				...
				<div
					...
					style={{
						background:
							'linear-gradient(135deg, var(--navy) 0%, var(--navy-light) 55%, var(--navy-muted) 100%)',
					}}>
					{/* Dot pattern */}
					<div
				...
				<div className='relative shrink-0 px-6 -mt-14 mb-4 flex items-end gap-4'>
					{alumni.profile_photo_url ? (
						...
						<div
							className='w-24 h-24 rounded-2xl flex items-center justify-center text-white text-2xl font-bold font-display shrink-0'
							style={{
								background:
				...
				<div className='flex-1 overflow-y-auto px-6 pb-10 space-y-6'>
					...
					<div>
						{alumni.distinctions && (
							<div
								className='inline-flex px-3 py-1.5 rounded-full text-xs font-semibold uppercase mb-2'
								style={{
					...
					{alumni.achievements && (
						<div
							...
							<div
								...
								style={{
									background:
										'linear-gradient(135deg, rgba(201,149,60,0.07), rgba(201,149,60,0.03))',
